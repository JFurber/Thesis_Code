...
S=2*np.random.randint(0,2,size =(num_agents,num_agents))-1 #randomised attraction/repulsion matrix
...
x = np.array([500, 1000,1000, 2000, 2000, 500, 3000, 2000,500, 1000,1000, 2000, 2000, 500, 3000, 2000, 600,1500,600,2000],dtype='float64') #


sde = SDE(2, 0.01, KDE,0.001,S)  # Each agent is 2D
...
for step in range(num_steps):
    # print(f"Step {step}: Current positions: {x[:4]}")  # Print first few positions for brevity
    x = sde.step(x)  # Update x with the new state returned by the step method
    # print(f"Step {step}: Updated positions: {x[:4]}")
    steps[step,:]=x
